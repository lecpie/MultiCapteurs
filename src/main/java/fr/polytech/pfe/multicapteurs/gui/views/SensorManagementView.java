...
public class SensorManagementView extends JPanel implements ActionListener, FocusListener, MouseListener, ChangeListener {
    ...
    private LibComponent addOnglet;
    ...
    public void mouseClicked(MouseEvent e) {
        if (sensorMenu.getSelectedIndex() == 0) {
            LibComponent newPan = new LibComponent();
            libs.add(newPan);
    ...
    public LibComponent addLabelLibsTonewTab(LibComponent panel) {
        panel.add("libraryLabel", new JLabel("Library"));
        return panel;
    }

    public LibComponent addComboBoxLibsTonewTab(LibComponent panel) {
    ...
    public LibComponent setNewTabName(LibComponent panel, String name) {
        panel.setName(name);
        return panel;
    }
    ...
    public LibComponent getAddOnglet() {
        return addOnglet;
    }
